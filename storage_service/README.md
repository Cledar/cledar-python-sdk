...
This package is part of the `common-services` SDK. Install it using:
...
```python
from storage_service.object_storage import ObjectStorageService, ObjectStorageServiceConfig
import io
