...
PipelineMessageData = TypeVar("PipelineMessageData", bound=pydantic.BaseModel)


@pydantic.dataclasses.dataclass
class PipelineMessageDataContainer(Generic[PipelineMessageData]):
    data: dict[str, Any] | PipelineMessageData


@pydantic.dataclasses.dataclass
class PipelineStageReference(
    Generic[PipelineMessageData],
...
@pydantic.dataclasses.dataclass
class PipelineMessageMetadata(Generic[PipelineMessageData]):
...
class InputMessageData(pydantic.BaseModel):
    chunks: Sequence[S3Metadata]


class InputMessagePayload(pydantic.BaseModel, PipelineMessage[InputMessageData]):
